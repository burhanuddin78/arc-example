...
router.post('/', function (req, res) {
  ...
  if (total) {
    if (category) {
      var msg = {
        to: 'burhanuddinimran012@gmail.com',
      ...
      var msg = {
        ...
        html: `
          ...
          <p style="font-size: 16px;">CustomFeature: ${customFeatures}</p>
